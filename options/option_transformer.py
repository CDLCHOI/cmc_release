...
def get_args_parser():
    ...
    parser.add_argument('--eval_mode', type=str, choices=['with_mm', 'no_mm'], default='no_mm')
    ...
    parser.add_argument('--roottype', type=str, default='s1') 
    parser.add_argument('--modeltype', type=str, default='s2') 
